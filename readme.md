...
3. **Реализация модулей:**
   ...
   - Модуль `fig.fig_num` — функция `fig_num(n)` (реализует квадратные числа)
...
Объект автоматизации — процесс ручного вычисления чисел Фибоначчи и квадратных чисел. Система заменяет ручной расчет автоматизированным с мгновенным выводом результата.
...
- Функция вычисления n-го квадратного числа
...
- Корректно вычисляет квадратные числа для n от 0 до 10^13
